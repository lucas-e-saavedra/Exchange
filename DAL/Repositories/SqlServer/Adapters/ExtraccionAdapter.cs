...
namespace DAL.Repositories.SqlServer.Adapters
{
    ...
    public sealed class ExtraccionAdapter: IEntityAdapter<Extraccion>  
    {
        private readonly static ExtraccionAdapter _instance = new ExtraccionAdapter();

        public static ExtraccionAdapter Current
        {
            get
            {
                return _instance;
        ...
        private ExtraccionAdapter()
        {
            //Implent here the initialization of your singleton
        }

        public Extraccion Adapt(object[] values)
        {
